...
#Ref lists for cDNA
cDNA_60_60_targets <- read.delim("Input/Panel_size_cDNA_60_60_targets.txt", header = FALSE) %>% pull(1)
cDNA_120_120_targets <- read.delim("Input/Panel_size_cDNA_120_120_targets.txt", header = FALSE) %>% pull(1)
cDNA_240_240_targets <- read.delim("Input/Panel_size_cDNA_240_240_targets.txt", header = FALSE) %>% pull(1)




#Ref lists for gDNA
gDNA_60_60_targets <- read.delim("Input/Panel_size_gDNA_60_60_targets.txt", header = FALSE) %>% pull(1)
gDNA_60_60_targets <- gDNA_60_60_targets %>% str_replace_all("_", "-")

gDNA_120_120_targets <- read.delim("Input/Panel_size_gDNA_120_120_targets.txt", header = FALSE) %>% pull(1)
gDNA_120_120_targets <- gDNA_120_120_targets %>% str_replace_all("_", "-")

gDNA_240_240_targets <- read.delim("Input/Panel_size_gDNA_240_240_targets.txt", header = FALSE) %>% pull(1)
