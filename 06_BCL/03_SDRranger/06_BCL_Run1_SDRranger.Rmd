...
plot_save_dir <- here("SDR005_Run1_Plots")
path_dir_gDNA_reads <- here("SDRranger_gDNA_output_Run1/raw_reads_bc_matrix")
path_dir_cDNA_reads <- here("SDRranger_RNA_output_Run1/raw_reads_bc_matrix")
path_dir_cDNA_umis <- here("SDRranger_RNA_output_Run1/raw_umis_bc_matrix")
panel_size_gDNA = 92
panel_size_RNA  = 307
...
cell_id_split <- data.frame(do.call('rbind', strsplit(as.character(cDNA_mat_reads_meta$cell_index),':',f1ixed=TRUE)))
colnames(cell_id_split) <- c("cell", "sbc")
Types <- data.frame(Type = c("FL_LN0267_1", "FL_LN0267_2", "FL_LN0267_3", "FL_LN0267_4", "DLBCL_LN0281_1", "DLBCL_LN0281_2", "DLBCL_LN0281_3", "DLBCL_LN0281_4"),
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat, project = "SDR005_Run1")
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat_mod, project = "SDR005_Run1")
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run1_Seurat_max_sbc_1000reads_cut.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run1_Seurat_max_sbc_1000reads_cut.rds"))
cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run1_Seurat_max_sbc_1000reads_cut.rds"))
...
group_colors <- c(FL_LN0267_1 = "#EADFB4", FL_LN0267_2 = "#9BB0C1", FL_LN0267_3 = "#51829B" , FL_LN0267_4 = "#F6995C", 
                  DLBCL_LN0281_1 = "#EFBC9B", DLBCL_LN0281_2 = "#FBF3D5",DLBCL_LN0281_3 = "#D6DAC8", DLBCL_LN0281_4 = "#9CAFAA")
...
#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nFeature_gDNA_reads >= 75)
#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nCount_RNA >= 100)
#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nCount_RNA <= 4000)
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run1_Seurat_filtered.rds"))

#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nCount_RNA >= 100)


cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run1_Seurat_filtered.rds"))
...
title = "nReads_gDNA_Density_filtered.pdf"
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run1_Seurat_filtered_clustered.rds"))

cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run1_Seurat_filtered_clustered.rds"))
...
title = "SDR005_Run1_UMAP_Type.pdf"
...
title = "SDR005_Run1_UMAP_Cluster.pdf"
...
title = "SDR005_Run1_UMAP_nFeature_gDNA.pdf"
...
title = "SDR005_Run1_UMAP_nFeature_RNA.pdf"
...
title = "SDR005_Run1_UMAP_nReads_gDNA.pdf"
...
title = "SDR005_Run1_UMAP_nCount_RNA.pdf"
...
title = "SDR005_Run1_UMAP_nReads_RNA.pdf"
...
title = "SDR005_Run1_UMAP_sbc_ratio.pdf"
...
cDNA_data_Seurat <- readRDS("SDR005_Run1_Plots/SDR005_Run1_Seurat_filtered_clustered.rds")
...
out_dir <- here("SDR005_Run1_Plots/01_Input_cells_txt/")
