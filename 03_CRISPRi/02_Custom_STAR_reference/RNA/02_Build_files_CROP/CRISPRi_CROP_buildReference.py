...
def buildPuro_GFP(cropseq_df):
    seqs = [getSeq(element, cropseq_df = cropseq_df) for element in ["puro", "t2a", "gfp","wpre"]]
    Puro_GFP_seq = ("").join(seqs)
    return(Puro_GFP_seq)
...
if __name__ ==  "__main__":
    ...
    seq_name = "Puro_GFP"
    sequence = buildPuro_GFP(cropseq_df)
