...
file_path <- "/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/04_GATK_Out"
...
annot <- read.delim("/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/05_Merged_VCFs/SDR002_genomic_annotation_file.txt") %>% dplyr::select(Chromosome, Start, End, ID = ID_full)
...
write.table(combined_df, file="/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/05_Merged_VCFs/SDR002_60_60_sub_merged.txt", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
write.table(header, file="/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/05_Merged_VCFs/header.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t")



#Read in again 

#combined_df <- read.delim("/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/05_Merged_VCFs/SDR002_60_60_sub_merged.txt", header = TRUE)
...
write.table(combined_df_filtered, file="/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_60_60_sub/05_Merged_VCFs/SDR002_60_60_sub_merged_cut.txt", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
