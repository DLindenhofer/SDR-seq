...
to_file <- metadata %>% dplyr::select(cell, nFeature_RNA_perc, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S4_h_nGenes_Violin_perc.csv"
...
to_file <- metadata %>% dplyr::select(cell, nFeature_gDNA_perc = nFeature_gDNA_cut_perc, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S4_c_nAmplicons_Violin_perc.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- metadata %>% dplyr::select(cell, nReads_gDNA, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S3_a_nReads_gDNA_Violin.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- metadata %>% dplyr::select(cell, nReads_RNA, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S3_c_nReads_RNA_Violin.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- metadata %>% dplyr::select(cell, nCount_RNA, nReads_gDNA, nFeature_gDNA_perc = nFeature_gDNA_cut_perc, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S4_a_nCount_RNA-nReads_gDNA-nFeature_gDNA_perc_gDNA.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- metadata %>% dplyr::select(cell, nCount_RNA, nReads_gDNA, nFeature_RNA_perc, Sample = orig.ident)
to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))
file_name = "Fig2_S4_f_nCount_RNA-nReads_gDNA-nFeature_gDNA_perc_RNA.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
p <- gDNA_mat_res_common %>% 
    group_by(Type, cell) %>%
    summarise(nReads_gDNA = sum(nReads_gDNA)) %>%
...
to_file <- gDNA_mat_res_common %>% 
    group_by(Type, cell) %>%
    summarise(nReads_gDNA = sum(nReads_gDNA)) %>% 
 dplyr::rename(Sample = Type)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480",))

to_file <- to_file %>% mutate(cell = gsub("^[0-9]+[-_]*", "", cell))
to_file <- to_file %>% mutate(cell = gsub("^[0-9]+[-_]*", "", cell))

file_name = "Fig2_S3_b_nReads_gDNA_Violin_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
p <- gDNA_mat_res_common %>%
      group_by(Type, cell) %>%
      dplyr::summarize(nFeature_gDNA_common = sum(nReads_gDNA > 10),                                     
      .groups = "drop") %>%                                    
...
to_file <- gDNA_mat_res_common %>%
      ...
      .groups = "drop") %>%                                    
        mutate(nFeature_gDNA_common_perc = nFeature_gDNA_common/60) %>%
  dplyr::select(-nFeature_gDNA_common) %>%
  dplyr::rename(Sample = Type)
...
file_name = "Fig2_S4_e_nAmplicons_Violin_perc_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
p <- RNA_reads_mat_res %>% 
  filter(ID %in% cDNA_targets_common) %>% 
      group_by(Type, cell) %>%
    summarise(nReads_RNA_reads = sum(nReads_RNA_reads)) %>%
...
to_file <- RNA_reads_mat_res %>% 
  filter(ID %in% cDNA_targets_common) %>% 
      group_by(Type, cell) %>%
    summarise(nReads_RNA = sum(nReads_RNA_reads)) %>%
 dplyr::rename(Sample = Type)
...
file_name = "Fig2_S3_d_nReads_RNA_Violin_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_mat_res_common  %>%
      group_by(Type, cell) %>%
      dplyr::summarize(nFeature_RNA_common = sum(nUMIs_RNA > 0),                                    
      .groups = "drop") %>%                                    
        mutate(nFeature_RNA_common_perc = nFeature_RNA_common/30) %>%
  dplyr::select(-nFeature_RNA_common) %>%
  dplyr::rename(Sample = Type)
...
file_name = "Fig2_S4_j_nGenes_Violin_perc_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- gDNA_reads_aver_expr  %>%
  dplyr::select(ID, frac_cells, avg_nReads_log1p, Sample = Type)
...
file_name = "Fig2_S4_b_gDNA_average_expression_vs_fract_cells_Exp_all.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- gDNA_reads_aver_expr_common  %>%
  dplyr::select(ID, frac_cells, avg_nReads_log1p, Sample = Type)
...
file_name = "Fig2_S4_d_gDNA_average_expression_vs_fract_cells_Exp_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
pl1 <-  gDNA_reads_aver_expr_common_figure  %>%
...
to_file <- gDNA_reads_aver_expr_common_figure  %>%
  dplyr::select(Class, avg_nReads_per_targ_log1p, avg_frac_cell_per_targ, Sample = Type)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_M_g_Dot_plot_expression_fraction_gDNA_common_for_figure.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
p <- gDNA_reads_aver_expr_common_figure  %>%
...
p <- gDNA_reads_aver_expr_common  %>%
    filter(!is.na(frac_cells_fc)) %>%
  filter(frac_cells_fc != "Inf") %>%
...
to_file <- gDNA_reads_aver_expr_common  %>%
  dplyr::select(Sample = Type, frac_cells_fc, avg_nReads_fc, avg_nReads_log1p)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_S5_a_FC_gDNA_frac_cells-vs-FC_gDNA_avg_nReads_commonn.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
p <- gDNA_reads_aver_expr_common_cor  %>%
...
to_file <- gDNA_reads_aver_expr_common_cor  %>%
  dplyr::select(Sample = Type, avg_nReads_60, avg_nReads)

to_file <- to_file %>% left_join(cor_data[,c(1:2)], by = c("Sample" = "Type"))

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_M_c_Correlation_gDNA_avg_nReads_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- gDNA_reads_aver_expr_common_cor  %>%
  dplyr::select(Sample = Type, frac_cells_60, frac_cells)
...
file_name = "Fig2_M_b_Correlation_gDNA_frac_cells_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_UMIs_aver_expr  %>%
  dplyr::select(ID, frac_cells, avg_nUMIs_log1p, Sample = Type)
...
file_name = "Fig2_S4_g_RNA_average_expression_vs_fract_cells_Exp_all.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_UMIs_aver_expr_common  %>%
  dplyr::select(ID, frac_cells, avg_nUMIs_log1p, Sample = Type)
...
file_name = "Fig2_S4_i_RNA_average_expression_vs_fract_cells_Exp_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <-  RNA_UMIs_aver_expr_common_figure  %>%
  dplyr::select(Class, avg_nUMIs_per_targ_log1p, avg_frac_cell_per_targ, Sample = Type)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_M_i_Dot_plot_expression_fraction_RNA_common_for_figure.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_UMIs_aver_expr_common  %>%
  dplyr::select(Sample = Type, frac_cells_fc, avg_nUMIs_fc, avg_nUMIs_log1p)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_S5_b_FC_RNA_frac_cells-vs-FC_RNA_avg_nUMIs_commonn.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_UMIs_aver_expr_common_cor  %>%
  dplyr::select(Sample = Type, avg_nUMIs_60, avg_nUMIs)
...
file_name = "Fig2_M_e_Correlation_RNA_avg_nReads_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
file_name = "Fig2_M_d_Correlation_RNA_frac_cells_common.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE) 
...
to_file <- RNA_UMIs_aver_expr_common  %>%
  dplyr::  select(Sample = Type, ID, avg_nUMIs_log1p)

to_file <- to_file %>% mutate(Sample = case_when(Sample == "SDR002_60_60" ~ "SDR002_120",
                                                 Sample == "SDR002_120_120" ~ "SDR002_240",
                                                 Sample == "SDR002_240_240" ~ "SDR002_480"))

file_name = "Fig2_M_j_Heatmap_RNA_log1p_common_scaled.csv"
write.csv(to_file, paste0(file_save_dir, "/", file_name), row.names = FALSE)      
