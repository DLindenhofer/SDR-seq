...
plot_save_dir <- here("SDR005_Run2_Plots")
path_dir_gDNA_reads <- here("SDRranger_gDNA_output_Run2/raw_reads_bc_matrix")
path_dir_cDNA_reads <- here("SDRranger_RNA_output_Run2/raw_reads_bc_matrix")
path_dir_cDNA_umis <- here("SDRranger_RNA_output_Run2/raw_umis_bc_matrix")
panel_size_gDNA = 92
panel_size_RNA  = 307
...
Types <- data.frame(Type = c("FL_LN0198_1", "FL_LN0198_2", "FL_LN0198_3", "FL_LN0198_4", "FL_LN0198_5", "FL_LN0198_6", "FL_LN0198_7", "FL_LN0198_8"),
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat, project = "SDR005_Run2")
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat_mod, project = "SDR005_Run2")
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run2_Seurat_max_sbc_1000reads_cut.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run2_Seurat_max_sbc_1000reads_cut.rds"))
cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run2_Seurat_max_sbc_1000reads_cut.rds"))
...
group_colors <- c(FL_LN0198_2 = "#EADFB4", FL_LN0198_2 = "#9BB0C1", FL_LN0198_3 = "#51829B", FL_LN0198_4 = "#F6995C", 
                  FL_LN0198_5 = "#EFBC9B", FL_LN0198_6 = "#FBF3D5", FL_LN0198_7 = "#D6DAC8", FL_LN0198_8 = "#9CAFAA")
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run2_Seurat_filtered.rds"))

#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nCount_RNA >= 100)


cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run2_Seurat_filtered.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR005_Run2_Seurat_filtered_clustered.rds"))

cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR005_Run2_Seurat_filtered_clustered.rds"))
...
title = "SDR005_Run2_UMAP_Type.pdf"
...
title = "SDR005_Run2_UMAP_Cluster.pdf"
...
title = "SDR005_Run2_UMAP_nFeature_gDNA.pdf"
...
title = "SDR005_Run2_UMAP_nFeature_RNA.pdf"
...
title = "SDR005_Run2_UMAP_nReads_gDNA.pdf"
...
title = "SDR005_Run2_UMAP_nCount_RNA.pdf"
...
title = "SDR005_Run2_UMAP_nReads_RNA.pdf"
...
title = "SDR005_Run2_UMAP_sbc_ratio.pdf"
...
#write.table(meta_monov, file =paste0(plot_save_dir,"/SDR005_Run2_MonoVar_cells.txt"), quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t")
#Need to make loop - sinto cant process so many cells at once


out_dir <- here("SDR005_Run2_Plots/01_Input_cells_txt/")
