...
cDNA_targets <- read.delim(file="Input/CRISPRi_TAP_seq_best_inner_primers_chromosomal_loc_add.txt")
...
export(cDNA_targets_coord_gr, "Input/CRISPRi_cDNA_TAP_REF_coord.bed", "bed")
...
write.table(cDNA_targets_coord, file="Input/CRISPRi_cDNA_TAP_REF.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
...
cDNA_targets <- read.delim("Input/CRISPRi_cDNA_TAP_REF.tsv")
...
write.csv(cDNA_targets_seq, file = "Input/CRISPRi_cDNA_TAP_REF_seqs.csv", quote = FALSE, row.names = FALSE, col.names = TRUE)
