...
plot_save_dir <- here("Plots_dCas9_GATK")
...
#all cells 
cDNA_data_Seurat <- readRDS(here("SDR001_dCas9_Plots/SDR001_dCas9_Seurat_filtered_clustered.rds"))

#Load in variants file from GATK and VEP
#Adjust skip according to vcf file - skip header

all_var_full <- read_tsv(here("/06_GATK_VEP/SDR001_dCas9.vcf"), skip = 60, col_names = TRUE)
...
out_put_dir <- here("SDR001_dCas9_Plots_GATK/All_variants_VAF_plots")
