...
#Get file names
file_names <- list.files(path = "/Volumes/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_120_120_sub/02_Input_cells_bam", pattern = "\\.bam$", full.names = FALSE)

file_path_add <- "/g/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_120_120_sub/02_Input_cells_bam/"
...
out_dir <- "/Volumes/steinmetz/projects/SDR_Shared_John_Dominik/SDR002/20240918_GATK_Subset/SDR002_120_120_sub/02_Input_GATK/"
