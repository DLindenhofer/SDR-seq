...
#strand_counts <- GTF_df_UTR_i %>%   count(strand)
...
export(cDNA_targets_coord_gr, "Input/05_BE_cDNA_targets_coord.bed", "bed")
...
write.table(cDNA_targets_coord, file="Input/05_BE_cDNA_TAP_REF.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
...
cDNA_targets <- read.delim("Input/05_BE_cDNA_TAP_REF.tsv")
...
write.csv(cDNA_targets_seq, file = paste0(path_save_dir,"05_BE_cDNA_TAP_REF_seqs.csv"), quote = FALSE, row.names = FALSE, col.names = TRUE)
