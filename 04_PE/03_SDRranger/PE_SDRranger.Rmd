...
plot_save_dir <- here("SDR001_PE_Plots")
path_dir_gDNA_reads <- here("SDRranger_gDNA_PE/raw_reads_bc_matrix")
path_dir_cDNA_reads <- here("SDRranger_RNA_PE/raw_reads_bc_matrix")
path_dir_cDNA_umis <- here("SDRranger_RNA_PE/raw_umis_bc_matrix")
panel_size_gDNA = 33
panel_size_RNA  = 47
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat, project = "SDR001_PE")
...
#Make Seurat
cDNA_data_Seurat <- CreateSeuratObject(cDNA_mat_mod, project = "SDR001_PE")
...
cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = Type == "PE_1" |
                                                          Type == "PE_2" |
                                                          Type == "PE_3" |
                                                          Type == "PE_4" )

saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR001_PE_Seurat_max_sbc_1000reads_cut.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR001_PE_Seurat_max_sbc_1000reads_cut.rds"))
cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR001_PE_Seurat_max_sbc_1000reads_cut.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR001_PE_Seurat_filtered.rds"))

#cDNA_data_Seurat <- subset(x = cDNA_data_Seurat, subset = nCount_RNA >= 100)


cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR001_PE_Seurat_filtered.rds"))
...
saveRDS(cDNA_data_Seurat, paste0(plot_save_dir,"/SDR001_PE_Seurat_filtered_clustered.rds"))

cDNA_data_Seurat <- readRDS(paste0(plot_save_dir,"/SDR001_PE_Seurat_filtered_clustered.rds"))
...
title = "SDR001_PE_UMAP_Cluster.pdf"
...
title = "SDR001_PE_UMAP_nFeature_gDNA.pdf"
...
title = "SDR001_PE_UMAP_nFeature_RNA.pdf"
...
title = "SDR001_PE_UMAP_nReads_gDNA.pdf"
...
title = "SDR001_PE_UMAP_nCount_RNA.pdf"
...
title = "SDR001_PE_UMAP_nReads_RNA.pdf"
...
title = "SDR001_PE_UMAP_sbc_ratio.pdf"
...
out_dir <- here("SDR001_PE_Plots/01_Input_cells_txt/")
